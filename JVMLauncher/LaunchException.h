...
enum{
	...
	COULD_NOT_FIND_START_SERVICE_METHOD		= 19,
	COULD_NOT_FIND_STOP_SERVICE_METHOD		= 20,
	COULD_NOT_FIND_SHUTDOWN_SERVICE_METHOD	= 21,
	COULD_NOT_FIND_PAUSE_SERVICE_METHOD		= 22,
	COULD_NOT_FIND_CONTINUE_SERVICE_METHOD	= 23,
	EXCEPTION_IN_JAVA_START_SERVICE_METHOD	= 24,
	COULD_NOT_CREATE_EVENT_FOR_JAVA_THREAD	= 25,
	COULD_NOT_CREATE_JAVA_SERVICE_STARTUP_THREAD = 26,
	TIMEOUT_JAVA_SERVICE_STARTUP_THREAD		= 27,
	WRONG_LAUNCH_CONFIGURATION_FILE_FORMAT  = 28,
	COULD_NOT_DESTROY_JVM					= 29,
	COULD_NOT_DETACH_THREAD_FROM_JVM		= 30,
	COULD_NOT_ATTACH_THREAD_TO_JVM		    = 31,
	COULD_NOT_EVALUATE_APPLICATION_DIRECTORY= 32,
	COULD_NOT_REGISTER_SERVICE_CONTROL_HANDLER=33,
	COULD_NOT_SET_SERVICE_STATUS=34,
	COULD_NOT_SET_CONSOLE_CTRL_HANDLER=35,
	EXCEPTION_IN_JAVA_SERVICE_CONTROL_METHOD=36,
	COULD_NOT_ENUMERATE_WINDOWS=37,
	COULD_NOT_MAP_VIEW_OF_VIEW=38,
	COULD_NOT_CREATE_FILE_MAPPING=39
} codes;
