...
#define APPICON "icons\\AdminServletEngine.ico"

static LPCSTR pcApplicationName = "AdminServletEngineC";
static LPCSTR pcClassName = "ivyteam.webapp.admin.AdminServletEngine";
