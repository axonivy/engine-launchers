...
#define APPICON "icons\\ServerAdministrator.ico"

static LPCSTR pcApplicationName = "ivyLicenceGeneratorC";
static LPCSTR pcClassName = "ivyteam.tools.licence.LicenceGen";
